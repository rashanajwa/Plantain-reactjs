    ...
    <React.Fragment>
      ...
      >
        ...
        <Typography
          ...
          gutterBottom
        >
          Inorder to detect and treat different pests and insects , we have collected thousands of images under various category. A brief description of each class are given below:       
        </Typography>
        ...
        <Card sx={{ backgroundColor: "#c9f583" }}>
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary">
              There are 3 classes of plantain pests collected and they are: Weevils, Larva, Earwigs 
          </Typography>
          </CardContent>
          <CardContent>
              ...
              <Grid item xs={4}>
                <Card sx={{}}>
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                    Cosmopolites sordidus, commonly known as the banana root borer, banana borer, or banana weevil, is a species of weevil in the family Curculionidae. It is a pest of banana cultivation and has a cosmopolitan distribution, being found in all parts of the world in which bananas are grown
                      <Button href="">
                      Show More...
                      </Button>
                    </Typography>
              ...
              <Grid item xs={4}>
                <Card sx={{}} color="primary">
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                    The black banana weevil (or the banana root borer) Cosmopolites sordidus is one of the most serious insect pests of bananas. This beetle has been transported throughout the banana growing regions of the world. Corms or rhizomes are used for propagation and eggs and larvae are easily transported therein.
                      <Button href="">
                      Show More...
                      </Button>
                    </Typography>
        ...
        {/* INSECT END */}
         ...
         <Card sx={{ backgroundColor: "#c9f583" }}>
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary">
              Stem is an essential part of the plantain trees. They are huge amount of diseases that effect the stems.Due to the inavailability of all diseases in a particular climate,we have collected two classes of stems, they are: Fusarium wilt and Healthy stems  
            </Typography>
          </CardContent>
          <CardContent>
            <Grid container spacing={2}>
              ...
              <Grid item xs={4}>
                <Card sx={{}} color="primary">
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                     This is a class of healthy stem which is not yet effected by any pests or diseases. 
                     It could be maintained properly with proper precautions for the healthy well being of the plantain trees.  
                      <Button href="">
                      Show More...
                      </Button>
                    </Typography>
       ...
       <Card sx={{ backgroundColor: "#c9f583" }}>
          <CardContent>
            ...
            <Typography variant="body2" color="text.secondary">
              There are 6 classes of leaves diseases that we had considered in the project. They are:
            </Typography>
          </CardContent>
          <CardContent>
            <Grid container spacing={2}>
              ...
              <Grid item xs={4}>
                <Card sx={{}} color="primary">
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                    Black Sigatoka is also known as black leaf streak. The pathogen Mycosphaerella fijiensis causes streaks that run parallel to the leaves. It is an ascomycete fungus that affects banana trees specifically in tropical climates; including Asia, West Africa, China, and South America.[7] Tropical weather is the preferred climate for banana cultivation, but it is also the environment where the pathogen thrives: hot and humid, with plenty of rainfall to aid in dispersal. The optimal environment of the pathogen is similar to that of the banana tree. The fungus infects mature banana leaves and will continue to cause infection without proper control
                      <Button href="">
                      Show More...
                      </Button>
                    </Typography>
              ...
              <Grid item xs={4}>
                <Card sx={{}}>
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Healthy leaves which includes banana leaves that are not affected by any of the diseases.
                      <Button href="">
                      Show More...
                      </Button>
                    </Typography>
